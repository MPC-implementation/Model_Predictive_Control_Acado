...
a[0] = (atan(((od[1]+(((real_t)(2.0000000000000000e+00)*od[2])*xd[0]))+((((real_t)(3.0000000000000000e+00)*od[3])*xd[0])*xd[0]))));
a[1] = ((real_t)(1.0000000000000000e+00)/((real_t)(1.0000000000000000e+00)+(pow(((od[1]+(((real_t)(2.0000000000000000e+00)*od[2])*xd[0]))+((((real_t)(3.0000000000000000e+00)*od[3])*xd[0])*xd[0])),2))));
a[2] = ((((real_t)(2.0000000000000000e+00)*od[2])+((((real_t)(3.0000000000000000e+00)*od[3])*xd[0])+(((real_t)(3.0000000000000000e+00)*od[3])*xd[0])))*a[1]);

/* Compute outputs: */
out[0] = ((((od[0]+(od[1]*xd[0]))+((od[2]*xd[0])*xd[0]))+(((od[3]*xd[0])*xd[0])*xd[0]))-xd[1]);
out[1] = (a[0]-xd[3]);
out[2] = (xd[2]-(real_t)(6.0000000000000000e+01));
out[3] = ((od[1]+((od[2]*xd[0])+(od[2]*xd[0])))+((((od[3]*xd[0])+(od[3]*xd[0]))*xd[0])+((od[3]*xd[0])*xd[0])));
...
{
acadoWorkspace.H[(iRow * 88 + 176) + (iCol * 2 + 4)] = 0.0;
acadoWorkspace.H[(iRow * 88 + 176) + (iCol * 2 + 5)] = 0.0;
acadoWorkspace.H[(iRow * 88 + 220) + (iCol * 2 + 4)] = 0.0;
acadoWorkspace.H[(iRow * 88 + 220) + (iCol * 2 + 5)] = 0.0;
}
...
acadoWorkspace.H[(lRun1 * 44) + (lRun2 + 4)] = acadoWorkspace.H10[(lRun2 * 4) + (lRun1)];
...
acadoWorkspace.H[(lRun1 * 44 + 176) + (lRun2)] = acadoWorkspace.H10[(lRun1 * 4) + (lRun2)];
...
acadoWorkspace.lb[4] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[0];
acadoWorkspace.lb[5] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[1];
acadoWorkspace.lb[6] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[2];
acadoWorkspace.lb[7] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[3];
acadoWorkspace.lb[8] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[4];
acadoWorkspace.lb[9] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[5];
acadoWorkspace.lb[10] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[6];
acadoWorkspace.lb[11] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[7];
acadoWorkspace.lb[12] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[8];
acadoWorkspace.lb[13] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[9];
acadoWorkspace.lb[14] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[10];
acadoWorkspace.lb[15] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[11];
acadoWorkspace.lb[16] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[12];
acadoWorkspace.lb[17] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[13];
acadoWorkspace.lb[18] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[14];
acadoWorkspace.lb[19] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[15];
acadoWorkspace.lb[20] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[16];
acadoWorkspace.lb[21] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[17];
acadoWorkspace.lb[22] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[18];
acadoWorkspace.lb[23] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[19];
acadoWorkspace.lb[24] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[20];
acadoWorkspace.lb[25] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[21];
acadoWorkspace.lb[26] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[22];
acadoWorkspace.lb[27] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[23];
acadoWorkspace.lb[28] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[24];
acadoWorkspace.lb[29] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[25];
acadoWorkspace.lb[30] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[26];
acadoWorkspace.lb[31] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[27];
acadoWorkspace.lb[32] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[28];
acadoWorkspace.lb[33] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[29];
acadoWorkspace.lb[34] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[30];
acadoWorkspace.lb[35] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[31];
acadoWorkspace.lb[36] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[32];
acadoWorkspace.lb[37] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[33];
acadoWorkspace.lb[38] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[34];
acadoWorkspace.lb[39] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[35];
acadoWorkspace.lb[40] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[36];
acadoWorkspace.lb[41] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[37];
acadoWorkspace.lb[42] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[38];
acadoWorkspace.lb[43] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[39];
acadoWorkspace.ub[4] = (real_t)1.0000000000000000e+00 - acadoVariables.u[0];
acadoWorkspace.ub[5] = (real_t)4.3630000000000002e-01 - acadoVariables.u[1];
acadoWorkspace.ub[6] = (real_t)1.0000000000000000e+00 - acadoVariables.u[2];
acadoWorkspace.ub[7] = (real_t)4.3630000000000002e-01 - acadoVariables.u[3];
acadoWorkspace.ub[8] = (real_t)1.0000000000000000e+00 - acadoVariables.u[4];
acadoWorkspace.ub[9] = (real_t)4.3630000000000002e-01 - acadoVariables.u[5];
acadoWorkspace.ub[10] = (real_t)1.0000000000000000e+00 - acadoVariables.u[6];
acadoWorkspace.ub[11] = (real_t)4.3630000000000002e-01 - acadoVariables.u[7];
acadoWorkspace.ub[12] = (real_t)1.0000000000000000e+00 - acadoVariables.u[8];
acadoWorkspace.ub[13] = (real_t)4.3630000000000002e-01 - acadoVariables.u[9];
acadoWorkspace.ub[14] = (real_t)1.0000000000000000e+00 - acadoVariables.u[10];
acadoWorkspace.ub[15] = (real_t)4.3630000000000002e-01 - acadoVariables.u[11];
acadoWorkspace.ub[16] = (real_t)1.0000000000000000e+00 - acadoVariables.u[12];
acadoWorkspace.ub[17] = (real_t)4.3630000000000002e-01 - acadoVariables.u[13];
acadoWorkspace.ub[18] = (real_t)1.0000000000000000e+00 - acadoVariables.u[14];
acadoWorkspace.ub[19] = (real_t)4.3630000000000002e-01 - acadoVariables.u[15];
acadoWorkspace.ub[20] = (real_t)1.0000000000000000e+00 - acadoVariables.u[16];
acadoWorkspace.ub[21] = (real_t)4.3630000000000002e-01 - acadoVariables.u[17];
acadoWorkspace.ub[22] = (real_t)1.0000000000000000e+00 - acadoVariables.u[18];
acadoWorkspace.ub[23] = (real_t)4.3630000000000002e-01 - acadoVariables.u[19];
acadoWorkspace.ub[24] = (real_t)1.0000000000000000e+00 - acadoVariables.u[20];
acadoWorkspace.ub[25] = (real_t)4.3630000000000002e-01 - acadoVariables.u[21];
acadoWorkspace.ub[26] = (real_t)1.0000000000000000e+00 - acadoVariables.u[22];
acadoWorkspace.ub[27] = (real_t)4.3630000000000002e-01 - acadoVariables.u[23];
acadoWorkspace.ub[28] = (real_t)1.0000000000000000e+00 - acadoVariables.u[24];
acadoWorkspace.ub[29] = (real_t)4.3630000000000002e-01 - acadoVariables.u[25];
acadoWorkspace.ub[30] = (real_t)1.0000000000000000e+00 - acadoVariables.u[26];
acadoWorkspace.ub[31] = (real_t)4.3630000000000002e-01 - acadoVariables.u[27];
acadoWorkspace.ub[32] = (real_t)1.0000000000000000e+00 - acadoVariables.u[28];
acadoWorkspace.ub[33] = (real_t)4.3630000000000002e-01 - acadoVariables.u[29];
acadoWorkspace.ub[34] = (real_t)1.0000000000000000e+00 - acadoVariables.u[30];
acadoWorkspace.ub[35] = (real_t)4.3630000000000002e-01 - acadoVariables.u[31];
acadoWorkspace.ub[36] = (real_t)1.0000000000000000e+00 - acadoVariables.u[32];
acadoWorkspace.ub[37] = (real_t)4.3630000000000002e-01 - acadoVariables.u[33];
acadoWorkspace.ub[38] = (real_t)1.0000000000000000e+00 - acadoVariables.u[34];
acadoWorkspace.ub[39] = (real_t)4.3630000000000002e-01 - acadoVariables.u[35];
acadoWorkspace.ub[40] = (real_t)1.0000000000000000e+00 - acadoVariables.u[36];
acadoWorkspace.ub[41] = (real_t)4.3630000000000002e-01 - acadoVariables.u[37];
acadoWorkspace.ub[42] = (real_t)1.0000000000000000e+00 - acadoVariables.u[38];
acadoWorkspace.ub[43] = (real_t)4.3630000000000002e-01 - acadoVariables.u[39];
...
acado_multRDy( acadoWorkspace.Dy, &(acadoWorkspace.g[ 4 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 3 ]), &(acadoWorkspace.g[ 6 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 6 ]), &(acadoWorkspace.g[ 8 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 9 ]), &(acadoWorkspace.g[ 10 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 12 ]), &(acadoWorkspace.g[ 12 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 15 ]), &(acadoWorkspace.g[ 14 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 18 ]), &(acadoWorkspace.g[ 16 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 21 ]), &(acadoWorkspace.g[ 18 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 24 ]), &(acadoWorkspace.g[ 20 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 27 ]), &(acadoWorkspace.g[ 22 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 30 ]), &(acadoWorkspace.g[ 24 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 33 ]), &(acadoWorkspace.g[ 26 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 36 ]), &(acadoWorkspace.g[ 28 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 39 ]), &(acadoWorkspace.g[ 30 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 42 ]), &(acadoWorkspace.g[ 32 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 45 ]), &(acadoWorkspace.g[ 34 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 48 ]), &(acadoWorkspace.g[ 36 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 51 ]), &(acadoWorkspace.g[ 38 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 54 ]), &(acadoWorkspace.g[ 40 ]) );
acado_multRDy( &(acadoWorkspace.Dy[ 57 ]), &(acadoWorkspace.g[ 42 ]) );
...
acadoWorkspace.state[32] = acadoVariables.od[82];
acadoWorkspace.state[33] = acadoVariables.od[83];
