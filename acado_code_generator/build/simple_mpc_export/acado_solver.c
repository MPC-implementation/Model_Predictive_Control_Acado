...
acadoWorkspace.objValueIn[0] = acadoVariables.x[28];
acadoWorkspace.objValueIn[1] = acadoVariables.x[29];
acadoWorkspace.objValueIn[2] = acadoVariables.x[30];
acadoWorkspace.objValueIn[3] = acadoVariables.x[31];
...
{
acadoWorkspace.H[(iRow * 28) + (iCol * 2)] += + Gu1[0]*Gu2[0] + Gu1[2]*Gu2[2] + Gu1[4]*Gu2[4] + Gu1[6]*Gu2[6];
acadoWorkspace.H[(iRow * 28) + (iCol * 2 + 1)] += + Gu1[0]*Gu2[1] + Gu1[2]*Gu2[3] + Gu1[4]*Gu2[5] + Gu1[6]*Gu2[7];
acadoWorkspace.H[(iRow * 28 + 14) + (iCol * 2)] += + Gu1[1]*Gu2[0] + Gu1[3]*Gu2[2] + Gu1[5]*Gu2[4] + Gu1[7]*Gu2[6];
acadoWorkspace.H[(iRow * 28 + 14) + (iCol * 2 + 1)] += + Gu1[1]*Gu2[1] + Gu1[3]*Gu2[3] + Gu1[5]*Gu2[5] + Gu1[7]*Gu2[7];
}

void acado_setBlockH11_R1( int iRow, int iCol )
{
acadoWorkspace.H[(iRow * 28) + (iCol * 2)] = 0.0;
acadoWorkspace.H[(iRow * 28) + (iCol * 2 + 1)] = 0.0;
acadoWorkspace.H[(iRow * 28 + 14) + (iCol * 2)] = 0.0;
acadoWorkspace.H[(iRow * 28 + 14) + (iCol * 2 + 1)] = 0.0;
}

void acado_zeroBlockH11( int iRow, int iCol )
{
acadoWorkspace.H[(iRow * 28) + (iCol * 2)] = 0.0000000000000000e+00;
acadoWorkspace.H[(iRow * 28) + (iCol * 2 + 1)] = 0.0000000000000000e+00;
acadoWorkspace.H[(iRow * 28 + 14) + (iCol * 2)] = 0.0000000000000000e+00;
acadoWorkspace.H[(iRow * 28 + 14) + (iCol * 2 + 1)] = 0.0000000000000000e+00;
}

void acado_copyHTH( int iRow, int iCol )
{
acadoWorkspace.H[(iRow * 28) + (iCol * 2)] = acadoWorkspace.H[(iCol * 28) + (iRow * 2)];
acadoWorkspace.H[(iRow * 28) + (iCol * 2 + 1)] = acadoWorkspace.H[(iCol * 28 + 14) + (iRow * 2)];
acadoWorkspace.H[(iRow * 28 + 14) + (iCol * 2)] = acadoWorkspace.H[(iCol * 28) + (iRow * 2 + 1)];
acadoWorkspace.H[(iRow * 28 + 14) + (iCol * 2 + 1)] = acadoWorkspace.H[(iCol * 28 + 14) + (iRow * 2 + 1)];
}
...
acado_multGxGu( acadoWorkspace.QN1, &(acadoWorkspace.E[ 168 ]), &(acadoWorkspace.QE[ 168 ]) );
acado_multGxGu( acadoWorkspace.QN1, &(acadoWorkspace.E[ 176 ]), &(acadoWorkspace.QE[ 176 ]) );
acado_multGxGu( acadoWorkspace.QN1, &(acadoWorkspace.E[ 184 ]), &(acadoWorkspace.QE[ 184 ]) );
acado_multGxGu( acadoWorkspace.QN1, &(acadoWorkspace.E[ 192 ]), &(acadoWorkspace.QE[ 192 ]) );
acado_multGxGu( acadoWorkspace.QN1, &(acadoWorkspace.E[ 200 ]), &(acadoWorkspace.QE[ 200 ]) );
acado_multGxGu( acadoWorkspace.QN1, &(acadoWorkspace.E[ 208 ]), &(acadoWorkspace.QE[ 208 ]) );
acado_multGxGu( acadoWorkspace.QN1, &(acadoWorkspace.E[ 216 ]), &(acadoWorkspace.QE[ 216 ]) );
...
acado_multQN1d( acadoWorkspace.QN1, &(acadoWorkspace.d[ 24 ]), &(acadoWorkspace.Qd[ 24 ]) );
...
acadoWorkspace.lb[1] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[1];
acadoWorkspace.lb[2] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[2];
acadoWorkspace.lb[3] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[3];
acadoWorkspace.lb[4] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[4];
acadoWorkspace.lb[5] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[5];
acadoWorkspace.lb[6] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[6];
acadoWorkspace.lb[7] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[7];
acadoWorkspace.lb[8] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[8];
acadoWorkspace.lb[9] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[9];
acadoWorkspace.lb[10] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[10];
acadoWorkspace.lb[11] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[11];
acadoWorkspace.lb[12] = (real_t)-1.0000000000000000e+00 - acadoVariables.u[12];
acadoWorkspace.lb[13] = (real_t)-4.3630000000000002e-01 - acadoVariables.u[13];
acadoWorkspace.ub[0] = (real_t)1.0000000000000000e+00 - acadoVariables.u[0];
acadoWorkspace.ub[1] = (real_t)4.3630000000000002e-01 - acadoVariables.u[1];
acadoWorkspace.ub[2] = (real_t)1.0000000000000000e+00 - acadoVariables.u[2];
acadoWorkspace.ub[3] = (real_t)4.3630000000000002e-01 - acadoVariables.u[3];
acadoWorkspace.ub[4] = (real_t)1.0000000000000000e+00 - acadoVariables.u[4];
acadoWorkspace.ub[5] = (real_t)4.3630000000000002e-01 - acadoVariables.u[5];
acadoWorkspace.ub[6] = (real_t)1.0000000000000000e+00 - acadoVariables.u[6];
acadoWorkspace.ub[7] = (real_t)4.3630000000000002e-01 - acadoVariables.u[7];
acadoWorkspace.ub[8] = (real_t)1.0000000000000000e+00 - acadoVariables.u[8];
acadoWorkspace.ub[9] = (real_t)4.3630000000000002e-01 - acadoVariables.u[9];
acadoWorkspace.ub[10] = (real_t)1.0000000000000000e+00 - acadoVariables.u[10];
acadoWorkspace.ub[11] = (real_t)4.3630000000000002e-01 - acadoVariables.u[11];
acadoWorkspace.ub[12] = (real_t)1.0000000000000000e+00 - acadoVariables.u[12];
acadoWorkspace.ub[13] = (real_t)4.3630000000000002e-01 - acadoVariables.u[13];
...
acadoWorkspace.QDy[28] = + acadoWorkspace.QN2[0]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[1]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[2]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[3]*acadoWorkspace.DyN[3];
acadoWorkspace.QDy[29] = + acadoWorkspace.QN2[4]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[5]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[6]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[7]*acadoWorkspace.DyN[3];
acadoWorkspace.QDy[30] = + acadoWorkspace.QN2[8]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[9]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[10]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[11]*acadoWorkspace.DyN[3];
acadoWorkspace.QDy[31] = + acadoWorkspace.QN2[12]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[13]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[14]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[15]*acadoWorkspace.DyN[3];
...
{
acadoVariables.x[28] = xEnd[0];
acadoVariables.x[29] = xEnd[1];
acadoVariables.x[30] = xEnd[2];
acadoVariables.x[31] = xEnd[3];
}
else if (strategy == 2) 
{
acadoWorkspace.state[0] = acadoVariables.x[28];
acadoWorkspace.state[1] = acadoVariables.x[29];
acadoWorkspace.state[2] = acadoVariables.x[30];
acadoWorkspace.state[3] = acadoVariables.x[31];
if (uEnd != 0)
{
...
{
acadoWorkspace.state[28] = acadoVariables.u[12];
acadoWorkspace.state[29] = acadoVariables.u[13];
}

acado_integrate(acadoWorkspace.state, 1);

acadoVariables.x[28] = acadoWorkspace.state[0];
acadoVariables.x[29] = acadoWorkspace.state[1];
acadoVariables.x[30] = acadoWorkspace.state[2];
acadoVariables.x[31] = acadoWorkspace.state[3];
}
}
...
kkt = + acadoWorkspace.g[0]*acadoWorkspace.x[0] + acadoWorkspace.g[1]*acadoWorkspace.x[1] + acadoWorkspace.g[2]*acadoWorkspace.x[2] + acadoWorkspace.g[3]*acadoWorkspace.x[3] + acadoWorkspace.g[4]*acadoWorkspace.x[4] + acadoWorkspace.g[5]*acadoWorkspace.x[5] + acadoWorkspace.g[6]*acadoWorkspace.x[6] + acadoWorkspace.g[7]*acadoWorkspace.x[7] + acadoWorkspace.g[8]*acadoWorkspace.x[8] + acadoWorkspace.g[9]*acadoWorkspace.x[9] + acadoWorkspace.g[10]*acadoWorkspace.x[10] + acadoWorkspace.g[11]*acadoWorkspace.x[11] + acadoWorkspace.g[12]*acadoWorkspace.x[12] + acadoWorkspace.g[13]*acadoWorkspace.x[13];
kkt = fabs( kkt );
